<template>
  <div class="sticky top-0 mx-auto w-full flex justify-between item-center h-16 bg-green-400">
    <!-- Stand in for vue-router-->
    <ul class="px-2 sm:self-center text-xl text-gray-800 font-bold border-t sm:border-none">
