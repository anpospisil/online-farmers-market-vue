<template>
  ...
  <div class="w-80 m-5 p-1 bg-gradient-to-b from-green-400 via-green-200 rounded-3xl shadow-md hover:shadow-2xl" v-for="product in products" :key="product.id">
    <div class="rounded-xl"><img class="mx-auto p-12 rounded-xl" :src="product.image" /></div>
